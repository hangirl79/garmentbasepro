...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$zip = $_POST['zip'];
	$note = $_POST['note'];
	$tran_code = $POST['tran_code'];
	
	$to = 'korina@islandtechnologies.net';
	$subject = 'Purchase';
	
	$message = $user_name . ' ' . $state . $comp . $note;
...
?>
    ...
    <div class="container-narrow">
     <div class="header"> 
     	<div class="main">
         <div class="logo">
				<h1><a href="index.html"><img src="assets/img/garment/logo.png" alt="" />LogoLink</a><h2>Software for the Apparel and Fashion Industry</h2></h1>
		 </div>		 
        </div>    
  </div>
      ...
      <div class="masthead">
         <nav class="nav">
          <ul>
              ...
              <li class="current"><a class="shoppingcart" href="purchase.html"><img src="assets/img/garment/shopping_cart.png" alt="" />Purchase</a></li>
          </ul>
      </nav>
	
      <div class="headline">
           <span class="mainlight">Purchase</span>
 	  </div><br/><br/>
             ...
             <div class="form_contents">
              <div class="row-fluid">
                <div class="container">
                  <div class="row">
                      <div class="span12">
                        <form class="form-horizontal" id="registerHere" method='post' action='purchase.php'>
                          <fieldset>
                       ...
                       <div class="control-group">
                        ...
                        <div class="control-group">
                              <div class="controls">
                               	  <label class="control-label_01" for="input01">Are you a Pad user?</label><br>  
                                <div class="btn-group">
                                    <label for="tran_code" class="fixedwidth">Yes <input type="radio" class="radioinput" name="tran_code" id="tran_code_22" value="22"/></label>
                                  </div>

                                <div class="btn-group" data-toggle-name="is_private" data-toggle="buttons-radio" >
                                  <label>No<input id="yes" style="width: 20px;" type='radio' name='yes' value='1'/></label>
                                </div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" class="btn_submit" name="btn_submit" rel="tooltip" title="first tooltip">Submit</button>
                          </div>
                        </div>
                         </fieldset>
                        </form>
                  ...
                  <hr>   
      <div class="footer">
        <div class="copyright">&copy; 2013 Island Technologies. All Rights Reserved.<span class="links"><a href="#">Privacy</a> <a href="terms.html">Terms</a> <a href="contact.html">Contact</a> <a href="#">Company</a></span></div>
      </div>
